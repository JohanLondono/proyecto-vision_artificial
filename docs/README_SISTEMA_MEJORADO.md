...
🤖 MODELOS PREENTRENADOS:
   • YOLO - Detección rápida (COCO dataset)
   • YOLO Custom - Modelo entrenado personalizado para sombreros 🎩 ¡NUEVO!
...
### ¡NUEVO! Entrenamiento YOLO Custom para Detección de Sombreros

El sistema ahora incluye un pipeline completo para entrenar modelos YOLO personalizados:

**Documentación completa:**
- 📚 [ENTRENAMIENTO_YOLO_SOMBREROS.md](ENTRENAMIENTO_YOLO_SOMBREROS.md) - Guía de entrenamiento paso a paso
- 🚀 [USO_MODELO_YOLO_CUSTOM.md](USO_MODELO_YOLO_CUSTOM.md) - Cómo usar el modelo entrenado

**Scripts disponibles:**
```bash
# 1. Preparar dataset de Open Images
python preparar_dataset_sombreros.py --input openimages_sombreros --output dataset_yolo_sombreros

# 2. Entrenar modelo YOLO Custom
...
# 4. Usar en el sistema principal
python sistema_deteccion_mejorado.py
# Seleccionar opción 2 (Video) → Modelo 11 (YOLO_CUSTOM)
```

**Características:**
- ✅ Dataset de 2,670 imágenes (6 clases de sombreros)
- ✅ Validación automática de estructura YOLO
- ✅ Entrenamiento con métricas en tiempo real
- ✅ Evaluación en dataset de prueba
- ✅ Integración con sistema de detección en video
